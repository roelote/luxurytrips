			...
			<div class="relative z-10 flex items-center justify-center h-full">
				<div class="container mx-auto px-4 text-center text-white">
					<div class="max-w-4xl mx-auto">
						...
						if ( ! empty( $categories ) ) : ?>
							<span class="inline-block bg-white/20 backdrop-blur-sm text-white text-sm font-medium px-4 py-2 rounded-full mb-6 uppercase tracking-wide">
		...
		<article class="py-16 bg-white">
			<div class="container mx-auto px-4">
				<div class="max-w-4xl mx-auto">
					...
					<!-- Excerpt si existe -->
					<?php if ( has_excerpt() ) : ?>
						<div class="text-xl text-gray-600 font-light leading-relaxed mb-12 pb-8 border-b border-gray-200">
							<?php the_excerpt(); ?>
						</div>
					<?php endif; ?>
					...
					<div class="prose max-w-none">
						<div class="text-lg leading-relaxed text-gray-700 space-y-6 
							...
							wp_link_pages(
								array(
									'before' => '<div class="flex justify-center items-center mt-8 pt-8 border-t border-gray-200 space-x-2 text-sm">' . esc_html__( 'PÃ¡ginas:', 'peruluxurytrips' ),
									'after'  => '</div>',
								)
							);
							?>
						...
						<div class="flex flex-wrap items-center justify-between gap-4">
							...
							if ( $tags_list ) :
								...
								<div class="flex flex-wrap items-center gap-2">
									...
									if ( $tags ) {
										foreach ( $tags as $tag ) {
											echo '<span class="inline-block bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs px-3 py-1 rounded-full transition-colors duration-200 cursor-pointer">';
							...
							<div class="flex items-center space-x-3">
								<span class="text-sm font-medium text-gray-600">Compartir:</span>
							...
							<?php if ( $prev_post ) : ?>
								<a href="<?php echo get_permalink( $prev_post->ID ); ?>" 
								   class="group flex items-center text-gray-600 hover:text-green-600 transition-colors duration-200 max-w-xs">
									...
									<div>
										<div class="text-xs text-gray-500 uppercase tracking-wide mb-1">Anterior</div>
								...
								<a href="<?php echo get_permalink( $next_post->ID ); ?>" 
								   class="group flex items-center justify-end text-gray-600 hover:text-green-600 transition-colors duration-200 max-w-xs ml-auto">
									<div class="text-right">
										<div class="text-xs text-gray-500 uppercase tracking-wide mb-1">Siguiente</div>
